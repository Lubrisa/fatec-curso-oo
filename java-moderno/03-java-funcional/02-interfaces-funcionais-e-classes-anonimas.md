...
| **`Function<T, R>`**      | `T -> R`              | `R apply(T t)`        | **Transformador:** Recebe um dado do tipo `T` e o converte em um resultado do tipo `R`.            | Extrair o nome do titular a partir de uma conta (`account -> account.getHolder()`). |
...
<a href="01-o-pensamento-funcional.md">← 1. O Pensamento Funcional</a>
