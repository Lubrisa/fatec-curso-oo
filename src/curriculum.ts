...
export const CURRICULUM_TREE: ModuleNode[] = [
  ...
  },
  {
    ...
    badge: 'Eixo',
    description: 'Maven, Lombok, Jackson, JDBC SQLite, Hibernate JPA e Spring Boot.',
    submodules: [
      {
      ...
      {
        id: 'ecossistema/spring-boot',
        title: 'Spring Boot (Framework & Web)',
        badge: 'Spring',
        description: 'Inversão de Controle, JPA com MySQL, REST APIs, RFC 7807 e Thymeleaf.',
        files: [
          {
            id: 'ecossistema/spring-boot/README.md',
            title: 'Visão Geral do Spring Boot',
            subtitle: 'Mapa da trilha, arquitetura e objetivos de aprendizado',
            moduleTitle: 'Ecossistema · Spring Boot',
            estimatedMinutes: 5,
          },
        ],
        submodules: [
          {
            id: 'ecossistema/spring-boot/01-base-e-arquitetura',
            title: '01 · Base e Arquitetura',
            badge: 'IoC',
            description: 'Filosofia, Spring Initializr, Injeção de Dependências e Beans.',
            files: [
              {
                id: 'ecossistema/spring-boot/01-base-e-arquitetura/01-introducao-e-filosofia-spring.md',
                title: '01. Introdução e Filosofia',
                subtitle: 'O que é Spring vs Spring Boot, Convention over Configuration e servidor embutido',
                moduleTitle: 'Spring Boot · 01 · Base e Arquitetura',
                estimatedMinutes: 10,
              },
              {
                id: 'ecossistema/spring-boot/01-base-e-arquitetura/02-setup-e-spring-initializr.md',
                title: '02. Setup e Spring Initializr',
                subtitle: 'Configuração no VS Code, dependências, versões GA e JAR vs WAR',
                moduleTitle: 'Spring Boot · 01 · Base e Arquitetura',
                estimatedMinutes: 9,
              },
              {
                id: 'ecossistema/spring-boot/01-base-e-arquitetura/03-injecao-de-dependencia-e-ioc.md',
                title: '03. Injeção de Dependência e IoC',
                subtitle: 'Ciclo de vida dos Beans, estereótipos (@Service, @Repository) e injeção por construtor',
                moduleTitle: 'Spring Boot · 01 · Base e Arquitetura',
                estimatedMinutes: 11,
              },
            ],
          ...
          {
            id: 'ecossistema/spring-boot/02-persistencia-e-dados',
            title: '02 · Persistência e Dados',
            badge: 'Data',
            description: 'MySQL, Entidades JPA, JpaRepository, Services e Transações.',
            files: [
              {
                id: 'ecossistema/spring-boot/02-persistencia-e-dados/01-configuracao-datasource-mysql.md',
                title: '01. DataSource MySQL',
                subtitle: 'Parametrização em application.properties, conexão MySQL e dialeto',
                moduleTitle: 'Spring Boot · 02 · Persistência e Dados',
                estimatedMinutes: 10,
              },
              {
                id: 'ecossistema/spring-boot/02-persistencia-e-dados/02-o-conceito-de-model-e-entidades.md',
                title: '02. Model e Entidades JPA',
                subtitle: 'Mapeamento JPA (@Entity, @Table), chaves com @Id e Lombok seguro',
                moduleTitle: 'Spring Boot · 02 · Persistência e Dados',
                estimatedMinutes: 11,
              },
              {
                id: 'ecossistema/spring-boot/02-persistencia-e-dados/03-spring-data-jpa-e-repositories.md',
                title: '03. Repositories e Spring Data',
                subtitle: 'Interface JpaRepository, CRUD automático e derived query methods',
                moduleTitle: 'Spring Boot · 02 · Persistência e Dados',
                estimatedMinutes: 11,
              },
              {
                id: 'ecossistema/spring-boot/02-persistencia-e-dados/04-camada-de-servico-e-regras-de-negocio.md',
                title: '04. Camada de Serviço',
                subtitle: 'A camada @Service, validações defensivas e propagação limpa de Optional',
                moduleTitle: 'Spring Boot · 02 · Persistência e Dados',
                estimatedMinutes: 11,
              },
              {
                id: 'ecossistema/spring-boot/02-persistencia-e-dados/05-controle-transacional-e-boas-praticas.md',
                title: '05. Transações e ACID',
                subtitle: '@Transactional, proxies AOP, armadilhas comuns e TransactionTemplate',
                moduleTitle: 'Spring Boot · 02 · Persistência e Dados',
                estimatedMinutes: 12,
              },
            ],
          ...
          {
            id: 'ecossistema/spring-boot/03-web-e-controllers',
            title: '03 · Web e Controllers',
            badge: 'REST',
            description: 'REST Controllers, Verbos HTTP, DTOs com Records e ResponseEntity.',
            files: [
              {
                id: 'ecossistema/spring-boot/03-web-e-controllers/01-rest-controllers-e-verbos-http.md',
                title: '01. REST Controllers & HTTP',
                subtitle: '@RestController, mapeamento de verbos HTTP e métodos seguros/idempotentes',
                moduleTitle: 'Spring Boot · 03 · Web e Controllers',
                estimatedMinutes: 10,
              },
              {
                id: 'ecossistema/spring-boot/03-web-e-controllers/02-parametros-de-rota-e-payloads.md',
                title: '02. Parâmetros e Payloads',
                subtitle: '@PathVariable, @RequestBody, DTOs com Java Records contra Mass Assignment',
                moduleTitle: 'Spring Boot · 03 · Web e Controllers',
                estimatedMinutes: 11,
              },
              {
                id: 'ecossistema/spring-boot/03-web-e-controllers/03-crud-restful-e-respostas-semanticas.md',
                title: '03. CRUD RESTful & Respostas',
                subtitle: 'ResponseEntity, status HTTP semânticos (200, 201, 204, 404) e cURL',
                moduleTitle: 'Spring Boot · 03 · Web e Controllers',
                estimatedMinutes: 12,
              },
            ],
          ...
          {
            id: 'ecossistema/spring-boot/04-tratamento-de-erros',
            title: '04 · Tratamento de Erros',
            badge: 'Erros',
            description: 'RFC 7807 ProblemDetail, @RestControllerAdvice e Exception Handlers.',
            files: [
              {
                id: 'ecossistema/spring-boot/04-tratamento-de-erros/01-excecoes-em-apis-e-respostas-padronizadas.md',
                title: '01. Erros em APIs e RFC 7807',
                subtitle: 'Perigos de stack trace, especificação RFC 7807 e ProblemDetail nativo',
                moduleTitle: 'Spring Boot · 04 · Tratamento de Erros',
                estimatedMinutes: 10,
              },
              {
                id: 'ecossistema/spring-boot/04-tratamento-de-erros/02-rest-controller-advice-e-exception-handlers.md',
                title: '02. Rest Controller Advice',
                subtitle: 'Centralização com @RestControllerAdvice, 400, 404, 409 e fallback seguro 500',
                moduleTitle: 'Spring Boot · 04 · Tratamento de Erros',
                estimatedMinutes: 12,
              },
            ],
          ...
          {
            id: 'ecossistema/spring-boot/05-mvc-e-views',
            title: '05 · MVC e Views',
            badge: 'MVC',
            description: 'Server-Side Rendering com Thymeleaf, objeto Model e padrão PRG.',
            files: [
              {
                id: 'ecossistema/spring-boot/05-mvc-e-views/01-o-padrao-mvc-classico-no-spring.md',
                title: '01. O Padrão MVC Clássico',
                subtitle: 'SSR vs APIs desacopladas, @Controller vs @RestController e Thymeleaf',
                moduleTitle: 'Spring Boot · 05 · MVC e Views',
                estimatedMinutes: 10,
              },
              {
                id: 'ecossistema/spring-boot/05-mvc-e-views/02-renderizacao-com-thymeleaf-e-model.md',
                title: '02. Thymeleaf e Model',
                subtitle: 'Injeção de Model, diretivas th:text/th:each/th:if, template e padrão PRG',
                moduleTitle: 'Spring Boot · 05 · MVC e Views',
                estimatedMinutes: 12,
              },
            ],
